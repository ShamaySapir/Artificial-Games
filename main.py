...
test_1 = "Passed" if test_minimax(2, print_all_moves=False, print_last=False) == TEST_2_SCORE else "Failed"
print("--- Test 2 alphabeta ---")
test_1_ab = "Passed" if test_alphabeta(2, print_all_moves=False, print_last=False) == TEST_2_SCORE else "Failed"
print('Minimax test 2: ', test_1)
print('Alphabeta test 2: ', test_1_ab)
